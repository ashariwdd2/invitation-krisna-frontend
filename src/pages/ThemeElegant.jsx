  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero-section" id="home">
        ...
        <h1 className="couple-names">{groom}</h1>
        <h1 className="couple-names">&</h1>
        <h1 className="couple-names">{bride}</h1>
      ...
      {showContent && (
        <>
          ...
          <section className="quote-section content-section" data-aos="fade-up">
            ...
            <p className="quote-src">QS. Ar-Rum · 21</p>
          </section>
          </div>
          ...
          <section className="gallery-section" id="gallery">
            ...
            >
              <p className="gallery-text">
                Beberapa momen indah yang kami abadikan.
              </p>
